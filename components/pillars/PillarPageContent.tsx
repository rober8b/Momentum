...
// Shared body for any page that renders one pillar by its view_type — used
// by the generic /p/[key] browser and by legacy routes (like /projects)
// once they're cut over to the dynamic engine, per docs/DYNAMIC_PILLARS.md.
// Keeping this in one place means both call sites stay in sync as new view
// types (list/kanban/custom) are added later.
